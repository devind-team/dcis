...
def delete_user_curator_group(curator_group_id: str | int, user_id: str | int) -> str | int:
    """Добавление пользователя в кураторскую группу."""
    curator_group: CuratorGroup = get_object_or_404(CuratorGroup, pk=curator_group_id)
...
def delete_organization_curator_group(curator_group_id: str | int, organization_id: str | int) -> str | int:
    """Добавление пользователя в кураторскую группу."""
    curator_group: CuratorGroup = get_object_or_404(CuratorGroup, pk=curator_group_id)

...
**Привилегии и права, связанные с периодом, не распространяется на документы этого периода.**
...
Вычисления режимов происходит для каждого пользователя во время запроса видимого периода/документа,
...
Если ни одно из условий не выполнено, то пользователь перенаправляется на страницу 404.

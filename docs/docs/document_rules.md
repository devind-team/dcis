...
- в множественном типе сбора:
  - дивизион пользователя добавлен в период и документ добавляется для этого дивизиона.
...
- в множественном типе сбора:
  - пользователь состоит в дивизионе, к которому привязан документ;
- в единичном типе сбора:
  - пользователь состоит в дивизионе, к которому привязана строка документа.

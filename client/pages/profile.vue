...
export default defineComponent({
  ...
  setup () {
    ...
    const links: ComputedRef<LinksType[]> = computed<LinksType[]>(() => ([
      ...
      { title: t('profile.settings.index') as string, to: 'profile-settings', permissions: 'core.view_user', icon: 'cogs' },
      { title: t('profile.security.name') as string, to: 'profile-security', permissions: 'core.view_user', icon: 'security' },
      { title: t('profile.file') as string, to: 'profile-files', permissions: 'core.view_user', icon: 'file-multiple' },
      {

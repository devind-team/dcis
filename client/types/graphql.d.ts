...
/** Схема запросов данных. */
export type QueryUserIndividualPrivilegesArgs = {
  periodId: Scalars['ID'];
  userId?: InputMaybe<Scalars['ID']>;
};
